...
#Asks person to press space
space = turtle.Turtle()
space.penup()
space.goto(-100,350)
space.write("press space to jump", move=False, align="left", font=("Arial", 32, "normal"))
space.hideturtle()
...
pipe2_bottom.dy = 0
#Gravity difficulty
gravity_size = input("What difficulty do you want? Easy - Medium - Hard?")
if (gravity_size == "Easy"):
    gravity = -0.3
elif (gravity_size == "Medium"):
    gravity = -0.5
elif (gravity_size == "Hard"):
    gravity = -0.8 
elif (gravity_size == "SMASH"):
    gravity = -1.5
elif (gravity_size == "SKYHI"):
    gravity = -0.11
elif (gravity_size == "DRIVE"):
    gravity = -0.3
    playsound('Audio.mp3')
else:
    gravity = -0.3
